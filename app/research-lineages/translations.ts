...
const english = {
  ...
  outputsCount: 'research outputs', exploreTree: 'Explore the decision tree ↓',
  ...
  format: 'Format', editorial: 'Editorial', compact: 'Compact', tree: 'Decision tree', landscape: '3D map', exploreLandscape: 'Explore the 3D landscape ↓', language: 'Language',
  formatHint: 'Read the families, scan tables, or explore the tree in 2D and 3D.',
...
const chinese: Record<keyof typeof english, string> = {
  ...
  outputsCount: '类研究产出', exploreTree: '探索决策树 ↓',
  familiesCount: '个研究家族', papersCount: '篇代表论文', dateBasis: '按首稿日期排列',
  compare: '比较研究家族 ↓', readChronology: '阅读进展编年史 ↓', explore: '浏览本页',
  format: '版式', editorial: '图文', compact: '紧凑', tree: '决策树', landscape: '三维版图', exploreLandscape: '探索三维版图 ↓', language: '语言',
  formatHint: '比较研究家族、速览表格，或通过二维决策树与三维版图探索论文。',
